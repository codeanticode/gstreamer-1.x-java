...
/**
 * <i>native declaration : glib-2.0/gio/gfileoutputstream.h:50</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> or <a href="http://bridj.googlecode.com/">BridJ</a> .
 */
@Library("GIO") 
public class GFileOutputStreamClass extends CPPObject {
	static {
		BridJ.register();
	}
	...
	/** C type : GOutputStreamClass */
	@Field(0) 
	public GFileOutputStreamClass parent_class(GOutputStreamClass parent_class) {
		this.io.setNativeObjectField(this, 0, parent_class);
		return this;
	}
	/** C type : query_info_callback* */
	@Field(1) 
	public Pointer<GFileOutputStreamClass.query_info_callback > query_info() {
		return this.io.getPointerField(this, 1);
	}
	/** C type : query_info_callback* */
	@Field(1) 
	public GFileOutputStreamClass query_info(Pointer<GFileOutputStreamClass.query_info_callback > query_info) {
		this.io.setPointerField(this, 1, query_info);
		return this;
	}
	/** C type : query_info_async_callback* */
	@Field(2) 
	public Pointer<GFileOutputStreamClass.query_info_async_callback > query_info_async() {
		return this.io.getPointerField(this, 2);
	}
	/** C type : query_info_async_callback* */
	@Field(2) 
	public GFileOutputStreamClass query_info_async(Pointer<GFileOutputStreamClass.query_info_async_callback > query_info_async) {
		this.io.setPointerField(this, 2, query_info_async);
		return this;
	}
	/** C type : query_info_finish_callback* */
	@Field(3) 
	public Pointer<GFileOutputStreamClass.query_info_finish_callback > query_info_finish() {
		return this.io.getPointerField(this, 3);
	}
	/** C type : query_info_finish_callback* */
	@Field(3) 
	public GFileOutputStreamClass query_info_finish(Pointer<GFileOutputStreamClass.query_info_finish_callback > query_info_finish) {
		this.io.setPointerField(this, 3, query_info_finish);
		return this;
	}
	/** C type : get_etag_callback* */
	@Field(4) 
	public Pointer<GFileOutputStreamClass.get_etag_callback > get_etag() {
		return this.io.getPointerField(this, 4);
	}
	/** C type : get_etag_callback* */
	@Field(4) 
	public GFileOutputStreamClass get_etag(Pointer<GFileOutputStreamClass.get_etag_callback > get_etag) {
	 ...
	 */
	@Field(5) 
	public GFileOutputStreamClass _g_reserved1(Pointer<gio.GVfsClass._g_reserved1_callback > _g_reserved1) {
	...
	/** C type : _g_reserved2_callback* */
	@Field(6) 
	public GFileOutputStreamClass _g_reserved2(Pointer<gio.GVfsClass._g_reserved2_callback > _g_reserved2) {
	...
	/** C type : _g_reserved3_callback* */
	@Field(7) 
	public GFileOutputStreamClass _g_reserved3(Pointer<gio.GVfsClass._g_reserved3_callback > _g_reserved3) {
	...
	/** C type : _g_reserved4_callback* */
	@Field(8) 
	public GFileOutputStreamClass _g_reserved4(Pointer<gio.GVfsClass._g_reserved4_callback > _g_reserved4) {
	...
	/** C type : _g_reserved5_callback* */
	@Field(9) 
	public GFileOutputStreamClass _g_reserved5(Pointer<gio.GVfsClass._g_reserved5_callback > _g_reserved5) {
		this.io.setPointerField(this, 9, _g_reserved5);
		return this;
	}
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:36</i> */
	public static abstract class goffset_callback extends Callback<goffset_callback > {
		public final void apply(Pointer<GFileOutputStream > stream) {
			apply(Pointer.getPeer(stream));
		}
		public abstract void apply(@Ptr long stream);
	};
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:37</i> */
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:38</i> */
	public static abstract class gboolean_callback2 extends Callback<gboolean_callback2 > {
		/**
		 * SKIPPED:<br>
		 * <i>native declaration : glib-2.0/gio/gfileoutputstream.h:18</i><br>
		 * gboolean_callback(GFileOutputStream* stream, goffset offset, GSeekType type, GCancellable* cancellable, GError** error);<br>
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:39</i> */
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:40</i> */
	public static abstract class gboolean_callback4 extends Callback<gboolean_callback4 > {
		public final void apply(Pointer<GFileOutputStream > stream, long size, Pointer<GCancellable > cancellable, Pointer<Pointer > error) {
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:41</i> */
	public static abstract class query_info_callback extends Callback<query_info_callback > {
		public final Pointer<GFileInfo > apply(Pointer<GFileOutputStream > stream, Pointer<Byte > attributes, Pointer<GCancellable > cancellable, Pointer<Pointer > error) {
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:42</i> */
	public static abstract class query_info_async_callback extends Callback<query_info_async_callback > {
		public final void apply(Pointer<GFileOutputStream > stream, Pointer<Byte > attributes, int io_priority, Pointer<GCancellable > cancellable, Pointer<GAsyncReadyCallback > callback, gpointer user_data) {
	...
	/** <i>native declaration : glib-2.0/gio/gfileoutputstream.h:43</i> */
	public static abstract class query_info_finish_callback extends Callback<query_info_finish_callback > {
		public final Pointer<GFileInfo > apply(Pointer<GFileOutputStream > stream, Pointer<GAsyncResult > result, Pointer<Pointer > error) {
