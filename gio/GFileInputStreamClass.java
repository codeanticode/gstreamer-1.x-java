...
/**
 * <i>native declaration : glib-2.0/gio/gfileinputstream.h:42</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> or <a href="http://bridj.googlecode.com/">BridJ</a> .
 */
@Library("GIO") 
public class GFileInputStreamClass extends CPPObject {
	static {
		BridJ.register();
	}
	...
	/** C type : GInputStreamClass */
	@Field(0) 
	public GFileInputStreamClass parent_class(GInputStreamClass parent_class) {
	...
	/** C type : query_info_callback* */
	@Field(1) 
	public GFileInputStreamClass query_info(Pointer<gio.GFileOutputStreamClass.query_info_callback > query_info) {
	...
	/** C type : query_info_async_callback* */
	@Field(2) 
	public GFileInputStreamClass query_info_async(Pointer<gio.GFileOutputStreamClass.query_info_async_callback > query_info_async) {
	...
	/** C type : query_info_finish_callback* */
	@Field(3) 
	public GFileInputStreamClass query_info_finish(Pointer<gio.GFileOutputStreamClass.query_info_finish_callback > query_info_finish) {
	 ...
	 */
	@Field(4) 
	public GFileInputStreamClass _g_reserved1(Pointer<gio.GVfsClass._g_reserved1_callback > _g_reserved1) {
	...
	/** C type : _g_reserved2_callback* */
	@Field(5) 
	public GFileInputStreamClass _g_reserved2(Pointer<gio.GVfsClass._g_reserved2_callback > _g_reserved2) {
	...
	/** C type : _g_reserved3_callback* */
	@Field(6) 
	public GFileInputStreamClass _g_reserved3(Pointer<gio.GVfsClass._g_reserved3_callback > _g_reserved3) {
	...
	/** C type : _g_reserved4_callback* */
	@Field(7) 
	public GFileInputStreamClass _g_reserved4(Pointer<gio.GVfsClass._g_reserved4_callback > _g_reserved4) {
	...
	/** C type : _g_reserved5_callback* */
	@Field(8) 
	public GFileInputStreamClass _g_reserved5(Pointer<gio.GVfsClass._g_reserved5_callback > _g_reserved5) {
		this.io.setPointerField(this, 8, _g_reserved5);
		return this;
	}
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:31</i> */
	public static abstract class goffset_callback extends Callback<goffset_callback > {
		public final void apply(Pointer<GFileInputStream > stream) {
			apply(Pointer.getPeer(stream));
		}
		public abstract void apply(@Ptr long stream);
	};
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:32</i> */
	...
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:33</i> */
	public static abstract class gboolean_callback2 extends Callback<gboolean_callback2 > {
		/**
		 * SKIPPED:<br>
		 * <i>native declaration : glib-2.0/gio/gfileinputstream.h:18</i><br>
		 * gboolean_callback(GFileInputStream* stream, goffset offset, GSeekType type, GCancellable* cancellable, GError** error);<br>
	...
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:34</i> */
	public static abstract class query_info_callback extends Callback<query_info_callback > {
		public final Pointer<GFileInfo > apply(Pointer<GFileInputStream > stream, Pointer<Byte > attributes, Pointer<GCancellable > cancellable, Pointer<Pointer > error) {
	...
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:35</i> */
	public static abstract class query_info_async_callback extends Callback<query_info_async_callback > {
		public final void apply(Pointer<GFileInputStream > stream, Pointer<Byte > attributes, int io_priority, Pointer<GCancellable > cancellable, Pointer<GAsyncReadyCallback > callback, gpointer user_data) {
	...
	/** <i>native declaration : glib-2.0/gio/gfileinputstream.h:36</i> */
	public static abstract class query_info_finish_callback extends Callback<query_info_finish_callback > {
		public final Pointer<GFileInfo > apply(Pointer<GFileInputStream > stream, Pointer<GAsyncResult > result, Pointer<Pointer > error) {
